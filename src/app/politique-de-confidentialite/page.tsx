      ...
      <div className="w-full max-w-7xl mx-auto mt-4 md:mt-8 lg:ml-8 flex flex-col">
        ...
        <div className="flex flex-col gap-12 w-full max-w-4xl text-[#000] font-inter mx-auto mt-4 mb-24 px-4 md:px-0">
          ...
          <div className="flex flex-col gap-4 text-center items-center mb-8">
            <h1 className="text-2xl md:text-3xl font-bold tracking-[0.1em] text-[#000] uppercase text-center">Politique de Confidentialité</h1>
          ...
          <div className="text-[15px] md:text-base font-light leading-relaxed max-w-3xl text-[#000]">
            ...
            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">1. Ce que nous collectons (L'essentiel)</h2>
            <p className="mb-4">
            ...
            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">2. Pourquoi vos données sont-elles ici ?</h2>
            ...
            <ul className="list-disc pl-6 flex flex-col gap-3">
              ...
              <li>Faciliter les collaborations internationales via notre partenaire Art Conversation (Artistes Sans Frontières).</li>
              <li>Assurer la sécurité de vos transactions artistiques.</li>
            </ul>

            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">3. Pas de frontières, mais des limites</h2>
            <p className="mb-4">
            ...
            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">4. Vos droits (Vous êtes le curateur)</h2>
            <p className="mb-4">
            ...
            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">5. Sécurité</h2>
            <p className="mb-4">
            ...
            <h2 className="text-lg md:text-xl font-bold tracking-widest text-[#000] uppercase mt-12 mb-6">6. Nous contacter</h2>
            <p className="mb-4">
